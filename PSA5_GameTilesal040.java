...
/**
  ...
  * few weeks.
  */
public class GameTilesal040 extends GameTile {
	...
	public static GameTile makeNewTile(int tileValue){
		GameTilesal040 gameTile = new GameTilesal040(tileValue);
		return gameTile;
	}
	...
	public GameTilesal040(int tileValue) {
